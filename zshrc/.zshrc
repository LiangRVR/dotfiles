...
# Write each command immediately, not just on shell exit
...
setopt HIST_VERIFY               # don't execute upon history expansion
...
# pnpm
export PNPM_HOME="/home/lrvr/.local/share/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
